...
// Type: MsgPack.Serialization.DefaultSerializers.AbstractReadOnlyCollectionMessagePackSerializer`2
...
namespace MsgPack.Serialization.DefaultSerializers
{
    ...
    where TCollection : IReadOnlyCollection<TItem>
  {
    ...
    internal override TCollection InternalUnpackFromCore(Unpacker unpacker)
    {
      ...
      return this._concreteDeserializer != null ? (TCollection) this._concreteDeserializer.UnpackFrom(unpacker) : base.InternalUnpackFromCore(unpacker);
    }
