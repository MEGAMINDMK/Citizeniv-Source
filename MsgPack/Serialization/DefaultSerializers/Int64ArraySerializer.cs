...
// Type: MsgPack.Serialization.DefaultSerializers.Int64ArraySerializer
...
{
  internal sealed class Int64ArraySerializer : MessagePackSerializer<long[]>
  {
    ...
    protected internal override void PackToCore(Packer packer, long[] objectTree)
    {
      ...
      foreach (long num in objectTree)
        packer.Pack(num);
    }
    ...
    protected internal override long[] UnpackFromCore(Unpacker unpacker)
    {
      ...
      Int64ArraySerializer.UnpackToCore(unpacker, collection, itemsCount);
      return collection;
    }
    ...
    protected internal override void UnpackToCore(Unpacker unpacker, long[] collection)
    {
      if (!unpacker.IsArrayHeader)
        throw SerializationExceptions.NewIsNotArrayHeader();
      Int64ArraySerializer.UnpackToCore(unpacker, collection, UnpackHelpers.GetItemsCount(unpacker));
    }
